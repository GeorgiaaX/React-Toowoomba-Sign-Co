...
//   return (
//     <Col xl={6} lg={6} md={6} sm={12} className="d-flex justify-content-center mb-4">
//       <div
//         className={`service-tile ${bordered ? "service-tile--bordered" : ""}`}
//         style={{height: "auto"}}
//       >
//         <div
//           className="flip-card"
...
//               <h6
//                 style={{ fontSize: "24px", color: "rgba(12, 140, 233, 0.8)", fontWeight: "600" }}
//               >
//                 {title}
//               </h6>
//               <p>{service}</p>
