...
function ProductsServices() {
    return (
        <>
        <h2 className = "services-title">Signage Products and <b className = "bold-word">Services</b></h2>
        <p className = "text-center mb-3 text-muted about-text mx-1">Let us help you create the perfect signage for your business from our range of signage products and services.</p>
            ...
            <Container className="product-container">
                <Row className="mt-4">
                    {renderProductColumn({
                        ...
                        title: "Building & Shopface Signage",
