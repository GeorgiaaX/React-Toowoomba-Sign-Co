...
function StructuralSignage() {
  useEffect(() => {
    document.title =
      "Structural Signage Toowoomba | Freestanding Signs Toowoomba & Darling Downs";
    document
      .querySelector('meta[name="description"]')
      .setAttribute(
        "content",
        "Create new structural signs or transform existing structural signage for your business on the Sunshine Coast to attract attention & leave a lasting impression. Contact Toowoomba Sign Co for a quote."
      );
  }, []);
