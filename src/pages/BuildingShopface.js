...
function BuildingShopface() {
  useEffect(() => {
    document.title =
      "Building Signs Toowoomba | Store front & Shop face signage";
    document
      .querySelector('meta[name="description"]')
      .setAttribute(
        "content",
        "Elevate the visibility of your business in Toowoomba with our expertly crafted building signs. From storefront signage to pylons, we can customise signage uniquely to your business."
      );
  }, []);
