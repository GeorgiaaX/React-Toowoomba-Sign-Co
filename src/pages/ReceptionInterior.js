...
function ReceptionInterior() {
  useEffect(() => {
    ...
    document
      ...
      .setAttribute(
        "content",
        "Transform your office or building in Toowoomba and the Darling Downs with reception and interior signage that can be tailored to your branding and colours. Call for a quote 0413 733 947."
      );
  }, []);
